...
(
	select distinct
		...
		,DoiTuong = dt.TenDoiTuong
		,DichVu = dv.TenDichVu
		,ThoiGianLayMau = convert(varchar(16),sl.tglaymau,120)
        ,ThoiGianKetQua = convert(varchar(16),sl.TGKetQua,120)
        ,ThoiGianIn = convert(varchar(16),sl.TgIn,120)
        ,Id = sl.Id
        ,KetQua = sl.KetQua
		,sl.IDRef
        ,CodeXn = sl.CodeXn
